...
export async function POST(request: NextRequest) {
  ...
  const { escrow, sellAmount, buyer} = sellOrder;
  ...
  const tokenContractAddress = "0xc2132D05D31c914a87C6611C10748AEb04B58e8F"; // USDT on Polygon
