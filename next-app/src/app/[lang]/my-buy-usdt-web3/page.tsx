  ...
  useEffect(() => {
    ...
    useEffect(() => {
      ...
      const fetchTransfers = async () => {
        ...
        fetch('/api/wallet/getTransfersByWalletAddress', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
                      ...
                      <div className="flex flex-row items-center gap-2">
                        ...
                        <div className="flex flex-row items-center gap-2">
                          ...
                          <div className="text-lg font-semibold text-white ">
                            {
                              user && user.nickname ? user.nickname : 'Unknown'
                            }
                          </div>
                        ...
                        {/* disconnect button */}
                        <button
                          className="text-sm bg-zinc-400 text-white px-2 py-1 rounded-md hover:bg-zinc-500"
                          onClick={() => {
