...
function AgentPage() {
    ...
    */
    ...
    const [erc721ContractAddress, setErc721ContractAddress] = useState("0x812e1F6EA563a079958f8210B1DF76Be27862039");
    ...
    const mintAgentNft = async () => {
        ...
        */
        ...
        try {
            ...
            const responseGenerateImage = await fetch("/api/ai/generateImageSMW", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            const nftDesscription = "This image is generated by AI";
                    ...
                    {/* address */}
                    {
                        ...
                        <div className='w-full flex flex-col gap-2 items-center justify-between
                            ...
                            <div className='w-full flex flex-col gap-2 items-start justify-between
                                ...
                                <button
                                    disabled={mintingAgentNft || ganeratingAgentImage || !agentName}
                                    onClick={
                                    ...
                                    className={`
                                        ${mintingAgentNft
                                        || ganeratingAgentImage || !agentName
