...
export async function insertOne(data: any) {
    ...
    const collectionUsers = client.db('shinemywinter').collection('user');

    const collectionUserTransfers = client.db('shinemywinter').collection('userTransfersNoahMiningNft');
